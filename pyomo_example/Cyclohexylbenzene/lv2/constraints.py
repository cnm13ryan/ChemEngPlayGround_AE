...
class Constraints:
    ...
    def Eq1(self, model):
        return model.params['FR_S21_LK'] * model.params['S15'] * model.params['S15_Hydrogen'] == model.s21['Hydrogen'] 

    def Eq2(self, model):
        return (1 - model.params['FR_S21_LK']) * model.params['S15'] * model.params['S15_Hydrogen'] == model.s20['Hydrogen'] 
    
    def Eq3(self, model):
        return model.params['FR_S20_HK'] * model.params['S15'] * model.params['S15_Methane'] == model.s20['Methane'] 

    def Eq4(self, model):
        return (1 - model.params['FR_S20_HK']) * model.params['S15'] * model.params['S15_Methane'] == model.s21['Methane'] 
        
        
    # Fractional recoveries of HK/LK (Distillation Column 8)       
    def Eq5(self, model):
        return model.params['FR_S22_LK'] * model.s20['Methane']  == model.s22['Methane'] 
    
    def Eq6(self, model):
        return (1 - model.params['FR_S22_LK']) * model.s20['Methane']  == model.s23['Methane'] 
    
    def Eq7(self, model):
        return model.params['FR_S23_HK'] * model.s20['Benzene']  == model.s23['Benzene'] 
    
    def Eq8(self, model):
        return (1 - model.params['FR_S23_HK']) * model.s20['Benzene']  == model.s22['Benzene'] 
    ...
    def Eq10(self, model):
        return (1 - model.params['FR_S25_LK']) * model.s24['Hydrogen']  == model.s26['Hydrogen'] 
    
    def Eq11(self, model):
        return model.params['FR_S26_HK'] * model.s24['Methane']  == model.s26['Methane'] 
    
    def Eq12(self, model):
        return (1 - model.params['FR_S26_HK']) * model.s24['Methane']  == model.s25['Methane'] 
    ...
    def Eq17(self, model):
        return model.params['FR_S34_LK'] * model.s32['Cyclohexane']  == model.s34['Cyclohexane']     
    
    def Eq18(self, model):
        return (1 - model.params['FR_S34_LK']) * model.s32['Cyclohexane']  == model.s35['Cyclohexane']     
    
    def Eq19(self, model):
        return model.params['FR_S35_HK'] * model.s32['Cyclohexene']  == model.s35['Cyclohexene'] 
    
    def Eq20(self, model):
        return (1 - model.params['FR_S35_HK']) * model.s32['Cyclohexene']  == model.s34['Cyclohexene']   
    ...
    def conversion_1_def_rule(self, model):
        return model.params['X1'] * (model.s23['Benzene'] + model.s29['Benzene']) ==  model.zeta_1 + model.zeta_2 
    ...
    def Hydrogen_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Hydrogen'] == model.s20['Hydrogen'] + model.s21['Hydrogen']
    
    def Hydrogen_comp_rule2(self, model):
        return model.s21['Hydrogen'] + model.s36['Hydrogen'] == model.s38['Hydrogen']
    
    def Hydrogen_comp_rule3(self, model):
        return model.s23['Hydrogen'] + model.s29['Hydrogen'] - model.zeta_1 - model.zeta_2 == model.s24['Hydrogen']
    ...
    def Hydrogen_comp_rule5(self, model):
        return model.s25['Hydrogen'] == model.s27['Hydrogen'] + model.s28['Hydrogen']
    
    def Hydrogen_comp_rule6(self, model):
        return model.s28['Hydrogen'] + model.s38['Hydrogen'] == model.s29['Hydrogen']  

    def Hydrogen_comp_rule7(self, model):
        return model.s26['Hydrogen'] + model.s35['Hydrogen'] == model.s30['Hydrogen']

    def Hydrogen_comp_rule8(self, model): # Assume no reaction
...
### Splitter fraction
    def Hydrogen_comp_rule10(self, model):
        return model.s28['Hydrogen'] == 5 * model.s27['Hydrogen']   
    ...
    ### Zero these streams                 
    def Hydrogen_comp_rule13(self, model): # stream zero hydrogen
        return model.s23['Hydrogen'] + model.s33['Hydrogen'] + model.s35['Hydrogen'] + model.s37['Hydrogen'] == 0   
    ...
    def Methane_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Methane'] == model.s20['Methane'] + model.s21['Methane']

    def Methane_comp_rule2(self, model):
        return model.s21['Methane'] + model.s36['Methane'] == model.s38['Methane']

    def Methane_comp_rule3(self, model):
        return model.s23['Methane'] + model.s29['Methane'] - model.zeta_1 - model.zeta_2 == model.s24['Methane']
    ...
    def Methane_comp_rule5(self, model):
        return model.s25['Methane'] == model.s27['Methane'] + model.s28['Methane']

    def Methane_comp_rule6(self, model):
        return model.s28['Methane'] + model.s38['Methane'] == model.s29['Methane']

    def Methane_comp_rule7(self, model):
        return model.s26['Methane'] + model.s35['Methane'] == model.s30['Methane']

    def Methane_comp_rule8(self, model):  # Assume no reaction
    ...
    def Methane_comp_rule10(self, model):
        return model.s28['Methane'] == 5 * model.s27['Methane']
    ...
    # Zero these streams
    def Methane_comp_rule13(self, model):  # stream zero methane
        return model.s33['Methane'] + model.s35['Methane'] + model.s37['Methane'] == 0
    ...
    def Benzene_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Benzene'] == model.s20['Benzene'] + model.s21['Benzene']

    def Benzene_comp_rule2(self, model):
        return model.s21['Benzene'] + model.s36['Benzene'] == model.s38['Benzene']

    def Benzene_comp_rule3(self, model):
        return model.s23['Benzene'] + model.s29['Benzene'] - model.zeta_1 - model.zeta_2 == model.s24['Benzene']
    ...
    def Benzene_comp_rule5(self, model):
        return model.s25['Benzene'] == model.s27['Benzene'] + model.s28['Benzene']

    def Benzene_comp_rule6(self, model):
        return model.s28['Benzene'] + model.s38['Benzene'] == model.s29['Benzene']

    def Benzene_comp_rule7(self, model):
        return model.s26['Benzene'] + model.s35['Benzene'] == model.s30['Benzene']
    ...
    def Benzene_comp_rule10(self, model):
        return model.s28['Benzene'] == 5 * model.s27['Benzene']
    ...
    # Zero these streams
    def Benzene_comp_rule13(self, model):  # stream zero benzene
        return model.s21['Benzene'] + model.s25['Benzene'] + model.s27['Benzene'] + model.s28['Benzene'] + model.s29['Benzene'] + model.s33['Benzene'] + model.s35['Benzene'] == 0

    
    # Cyclohexane (Individual Component material balance)

    def Cyclohexane_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Cyclohexane'] == model.s20['Cyclohexane'] + model.s21['Cyclohexane']

    def Cyclohexane_comp_rule2(self, model):
        return model.s21['Cyclohexane'] + model.s36['Cyclohexane'] == model.s38['Cyclohexane']

    def Cyclohexane_comp_rule3(self, model):
        return model.s23['Cyclohexane'] + model.s29['Cyclohexane'] + model.zeta_2 == model.s24['Cyclohexane']
    ...
    def Cyclohexane_comp_rule5(self, model):
        return model.s25['Cyclohexane'] == model.s27['Cyclohexane'] + model.s28['Cyclohexane']

    def Cyclohexane_comp_rule6(self, model):
        return model.s28['Cyclohexane'] + model.s38['Cyclohexane'] == model.s29['Cyclohexane']

    def Cyclohexane_comp_rule7(self, model):
        return model.s26['Cyclohexane'] + model.s35['Cyclohexane'] == model.s30['Cyclohexane']
    ...
    def Cyclohexane_comp_rule10(self, model):
        return model.s28['Cyclohexane'] == 5 * model.s27['Cyclohexane']

    def Cyclohexane_comp_rule11(self, model):
        return model.s32['Cyclohexane'] == model.s34['Cyclohexane'] + model.s35['Cyclohexane']

    def Cyclohexane_comp_rule12(self, model):
        return model.s34['Cyclohexane'] == model.s36['Cyclohexane'] + model.s37['Cyclohexane']

    # Zero these streams
    def Cyclohexane_comp_rule13(self, model):  # stream zero cyclohexane
        return model.s20['Cyclohexane'] + model.s21['Cyclohexane'] + model.s22['Cyclohexane'] + model.s23['Cyclohexane'] + model.s25['Cyclohexane'] + model.s27['Cyclohexane'] + model.s28['Cyclohexane'] + model.s33['Cyclohexane'] == 0

    
    # Cyclohexene (Individual Component material balance)

    def Cyclohexene_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Cyclohexene'] == model.s20['Cyclohexene'] + model.s21['Cyclohexene']

    def Cyclohexene_comp_rule2(self, model):
        return model.s21['Cyclohexene'] + model.s36['Cyclohexene'] == model.s38['Cyclohexene']

    def Cyclohexene_comp_rule3(self, model):
        return model.s23['Cyclohexene'] + model.s29['Cyclohexene'] + model.zeta_1 == model.s24['Cyclohexene']
    ...
    def Cyclohexene_comp_rule5(self, model):
        return model.s25['Cyclohexene'] == model.s27['Cyclohexene'] + model.s28['Cyclohexene']

    def Cyclohexene_comp_rule6(self, model):
        return model.s28['Cyclohexene'] + model.s38['Cyclohexene'] == model.s29['Cyclohexene']

    def Cyclohexene_comp_rule7(self, model):
        return model.s26['Cyclohexene'] + model.s35['Cyclohexene'] == model.s30['Cyclohexene']

    def Cyclohexene_comp_rule8(self, model):  # Assume no reaction
    ...
    def Cyclohexene_comp_rule10(self, model):
        return model.s28['Cyclohexene'] == 5 * model.s27['Cyclohexene']

    def Cyclohexene_comp_rule11(self, model):
        return model.s32['Cyclohexene'] == model.s34['Cyclohexene'] + model.s35['Cyclohexene']

    def Cyclohexene_comp_rule12(self, model):
        return model.s34['Cyclohexene'] == model.s36['Cyclohexene'] + model.s37['Cyclohexene']

    # Zero these streams
    def Cyclohexene_comp_rule13(self, model):  # stream zero cyclohexene
        return model.s20['Cyclohexene'] + model.s21['Cyclohexene'] + model.s22['Cyclohexene'] + model.s23['Cyclohexene'] + model.s25['Cyclohexene'] + model.s27['Cyclohexene'] + model.s28['Cyclohexene'] + model.s29['Cyclohexene'] + model.s36['Cyclohexene'] + model.s38['Cyclohexene']== 0


    # Cyclohexylbenzene (Individual Component material balance)

    def Cyclohexylbenzene_comp_rule1(self, model):
        return model.params['S15'] * model.params['S15_Cyclohexylbenzene'] == model.s20['Cyclohexylbenzene'] + model.s21['Cyclohexylbenzene']

    def Cyclohexylbenzene_comp_rule2(self, model):
        return model.s21['Cyclohexylbenzene'] + model.s36['Cyclohexylbenzene'] == model.s38['Cyclohexylbenzene']

    def Cyclohexylbenzene_comp_rule3(self, model):
        return model.s23['Cyclohexylbenzene'] + model.s29['Cyclohexylbenzene'] == model.s24['Cyclohexylbenzene']
    ...
    def Cyclohexylbenzene_comp_rule5(self, model):
        return model.s25['Cyclohexylbenzene'] == model.s27['Cyclohexylbenzene'] + model.s28['Cyclohexylbenzene']

    def Cyclohexylbenzene_comp_rule6(self, model):
        return model.s28['Cyclohexylbenzene'] + model.s38['Cyclohexylbenzene'] == model.s29['Cyclohexylbenzene']

    def Cyclohexylbenzene_comp_rule7(self, model):
        return model.s26['Cyclohexylbenzene'] + model.s35['Cyclohexylbenzene'] == model.s30['Cyclohexylbenzene']
    ...
    def Cyclohexylbenzene_comp_rule12(self, model):
    ...
    def Cyclohexylbenzene_comp_rule13(self, model):  # stream zero cyclohexylbenzene
        return model.s20['Cyclohexylbenzene'] + model.s21['Cyclohexylbenzene'] + model.s22['Cyclohexylbenzene'] + model.s23['Cyclohexylbenzene'] + model.s24['Cyclohexylbenzene'] + model.s25['Cyclohexylbenzene'] + model.s26['Cyclohexylbenzene'] + model.s27['Cyclohexylbenzene'] + model.s28['Cyclohexylbenzene'] + model.s29['Cyclohexylbenzene'] + model.s34['Cyclohexylbenzene'] + model.s36['Cyclohexylbenzene'] + model.s37['Cyclohexylbenzene'] + model.s38['Cyclohexylbenzene'] == 0
